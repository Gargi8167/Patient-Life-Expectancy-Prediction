...
The project follows a complete **Machine Learning pipeline**, starting from understanding the problem statement to implementing advanced **ensemble techniques**.
...
The main objective of this project is to apply **Machine Learning and Ensemble Techniques** to healthcare data in order to:
